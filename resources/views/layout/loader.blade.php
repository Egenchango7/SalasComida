    ...
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
        ...
        <circle cx="84" cy="50" r="10" fill="#7cb342">
            ...
            <animate attributeName="fill" repeatCount="indefinite" dur="2s" calcMode="discrete"
                keyTimes="0;0.25;0.5;0.75;1" values="#7cb342;#008000;#7cb342;#008000;#7cb342" begin="0s"></animate>
        </circle>
        <circle cx="16" cy="50" r="10" fill="#7cb342">
